Desy::Application.routes.draw do
  ...
  post 'users/upgrade_trial/send'           => 'users#send_upgrade_trial',     :as => :user_send_upgrade_trial
  get  'users/upgrade_trial/confirm/:token' => 'users#upgrade_trial',          :as => :user_upgrade_trial
