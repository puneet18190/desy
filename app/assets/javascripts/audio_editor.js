...
function selectAudioEditorComponent(component) {
  ...
  component.find('._media_player_slider').css('opacity', 1);
...
function deselectAllAudioEditorComponents() {
  ...
  $('._audio_editor_component._selected ._media_player_slider').css('opacity', 0.2);
...
function switchBackAudioComponentsFromPreviewMode() {
  ...
  $('._audio_editor_component ._media_player_slider').css('opacity', 0.2);
...
function switchAudioComponentsToPreviewMode() {
  ...
  $('._audio_editor_component ._media_player_slider').css('opacity', 1);
