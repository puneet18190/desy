		...
		init: function(ed, url) {
			ed.addCommand('equationCommand', function(a, latex)	{
	  		...
	  		//open a popup window when the button is clicked
				...
				{
					var url='http://latex.codecogs.com/editor_json3.php?design=mini&type=url&editor=TinyMCE';
					...
					popupEqnwin=window.open('','LaTexEditor','width=700,height=450,status=1,scrollbars=yes,resizable=1,design=mini');
