...
8. If it is a web server installation:
    ...
    1. Configure Unicorn as application server (you can use +config/unicorn.init.d.example+ as init script and +config/unicorn.conf.example+ as service configuration, while +config/unicorn.rb.example+ as Unicorn processes configuration)
