...
# TODO explain script/install
If DeSY is going to be installed on a dedicated clean machine, you can run `script/install ...`

Otherwise you can proceed with a manual installation:

1.  Extract the DeSY copy into the destination path (it should be somewhere inside the home of the user which runs the app)
...
11. If nginx web server is used, you can use +config/nginx.conf.example+ as start for the DeSY site configuration file
12. 
