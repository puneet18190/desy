    ...
    path =
      ...
      when 'production'
        ...
        DOCUMENTS_FOLDER.join(
          case id
            when 2 then 'conversazioni_multicast_V0_Gku5sX_k2wyViHBSFcg.odt'
            when 3 then 'espandibili-tar_akxjd2lUjnlSDqwmrC_pKA.gz'
            when 4 then 'coldiretti-it__rev_sp3_27052010_wmHjC4w1X3r8UOAlMTMsrg.pptx'
          end )
      end
    File.open path
  end
