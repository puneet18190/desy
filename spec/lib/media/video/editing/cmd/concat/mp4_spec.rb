        ...
        class Concat
          describe Mp4 do
            ...
            context 'with audio input' do
              ...
              its(:to_s) { should == %Q[#{pre_command} -i video\\ input -i audio\\ input -sn -threads #{AVCONV_OUTPUT_THREADS[:mp4]} -q:v 1 -q:a 4 -c:v libx264 -c:a libm4alame -t 10.0 -shortest out\\ put] }
            end
